            ...
            <nav aria-label="breadcrumb">
                <div class="d-flex align-items-center">
                    <a href="{{ route('user.dashboard') }}">
                        <span class="px-3 font-weight-bold text-lg text-white me-4">{{env('APP_NAME')}}</span>
                    </a>
                </div>
            </nav>
            <ul class="navbar-nav d-none d-lg-flex">
                <li class="nav-item px-3 py-3 border-radius-sm  d-flex align-items-center">
                  <a href="" class="nav-link text-white p-0">Hotels</a>
                  
                </li>
                <li class="nav-item px-3 py-3 border-radius-sm  d-flex align-items-center">
                  <a href="" class="nav-link text-white p-0">Activities</a>
                  
                </li>
                <li class="nav-item px-3 py-3 border-radius-sm  d-flex align-items-center">
                  <a href="" class="nav-link text-white p-0">Landmarks</a>
                  
                </li>
                <li class="nav-item px-3 py-3 border-radius-sm  d-flex align-items-center">
                  <a href="" class="nav-link text-white p-0">Events</a>
                  
                </li>
                <li class="nav-item px-3 py-3 border-radius-sm  d-flex align-items-center">
                  <a href="" class="nav-link text-white p-0">Views</a>
            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                <ul class="navbar-nav ms-md-auto  justify-content-end">
                    ...
                    <li class="nav-item dropdown pe-2 d-flex align-items-center">
                        <a href="javascript:;" class="nav-link text-white p-0 show" id="dropdownMenuButton"
                    ...
                    <li class="nav-item d-flex align-items-center ps-2">
                        {{-- <a href="#" class="nav-link text-white font-weight-bold px-0" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <li class="nav-item dropdown pe-2 d-flex align-items-center">
